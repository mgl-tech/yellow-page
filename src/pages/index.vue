...
<div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
    <div class="container xl:max-w-6xl mx-auto px-4">
        ...
        <header class="text-center mx-auto mb-12 lg:px-20">
            <h2 class="text-2xl leading-normal mb-2 font-bold text-black">职责，职能，技能</h2>
            ...
            <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">清晰的逻辑思维配上过硬的技术节省很多时间成本 &amp; 毕竟时间是最宝贵的！！</p>
        </header>
        <!-- End heading -->
        <!-- row -->
